...
| 已揭露注音 | 可能是 | 不該是 |
|---|---|---|
| ㄖ | 熱血、銳利、柔軟、日常 | 柔（太短，注音揭露通常不只開頭一個注音就換字） |
| ㄙ | 森林、書桌、速度、隨便 | 書（同上） |
| ㄊㄡˊ | 頭盔、投籃、頭痛、投擲 | 投（注音揭露了一整格完整音節） |
| ㄨㄛ | 渦輪、我愛、握手 | 握（完整音節應有更多線索） |
| ㄓㄨㄛ | 桌子、卓越、捉迷藏 | 這裡（調號不符） |

判斷原則：
- 已揭露的注音如果是「多個完整音節」（如 ㄊㄡˊ、ㄓㄨㄛˉ），代表前半段的音已經確定，後半段還有字沒揭露
- 已揭露的注音如果只是「單一注音符號」（如 ㄖ、ㄙ），可能是兩個字詞的第一個字的聲母
